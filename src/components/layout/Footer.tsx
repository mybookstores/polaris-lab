...
import { Mail, MapPin, Globe, Code, Users } from "lucide-react";
...
// Custom SVG icons for GitHub and Twitter
...
const socialLinks = [
  ...
  { icon: Mail, href: "mailto:contact@polarislab.ai", label: "Email" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-md mb-4">
              Pioneering AI research at Peking University. From AI for Science to Physical AI,
